                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="px-4 pb-4 text-sm leading-relaxed text-slate-400">
                        Answer goes here — replace with real content for
                        &quot;{question}&quot;
                      </p>
                    </div>
                  </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/50 p-6 sm:p-8">
          ...
          >
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full resize-none rounded-lg border border-slate-700 bg-slate-900/70 px-4 py-3 text-sm text-white placeholder:text-slate-500 outline-none focus:border-orange-400"
            />
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 flex items-center gap-2.5 rounded-full bg-orange-500 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          {/* Illustration */}
          {/* <div className="pointer-events-none absolute right-5 top-2 h-15 w-15 md:bottom-1 md:h-50 md:w-50">
            <svg
              viewBox="0 0 24 24"
              fill="none"
